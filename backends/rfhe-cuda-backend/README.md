...
The `rfhe-cuda-backend` holds the code for GPU acceleration of Initverse's variant of RFHE.
...
- an amortized implementation of the RFHE programmable bootstrap: `cuda_bootstrap_amortized_lwe_ciphertext_vector_32` and `cuda_bootstrap_amortized_lwe_ciphertext_vector_64`
- a low latency implementation of the RFHE programmable bootstrap: `cuda_bootstrap_low latency_lwe_ciphertext_vector_32` and `cuda_bootstrap_low_latency_lwe_ciphertext_vector_64`
...
The Cuda project held in `rfhe-cuda-backend` can be compiled independently from RFHE-rs in the following way:
```
git clone git@github.com:Project-InitVerse/rfhe-rs
cd backends/rfhe-cuda-backend/cuda
mkdir build
cd build
cmake ..
make
...
- [RFHE](https://eprint.iacr.org/2018/421.pdf)

## License

This software is distributed under the BSD-3-Clause-Clear license. If you have any questions,
please contact us at `hello@initverse.org`.
