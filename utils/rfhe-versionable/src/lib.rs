...
//! These traits can be generated using the [`rfhe_versionable_derive::Versionize`] proc macro.
...
use serde::Serialize;
pub use rfhe_versionable_derive::{NotVersioned, Version, Versionize, VersionsDispatch};
