    ...
    T: UnsignedInteger,
{
    ...
    ///
    /// ```rust
    /// use rfhe::core_crypto::commons::math::decomposition::SignedDecomposer;
    /// use rfhe::core_crypto::commons::parameters::{DecompositionBaseLog, DecompositionLevelCount};
    /// let decomposer =
    ...
    ///
    /// ```rust
    /// use rfhe::core_crypto::commons::math::decomposition::{DecompositionLevel, SignedDecomposer};
    /// use rfhe::core_crypto::commons::parameters::{DecompositionBaseLog, DecompositionLevelCount};
    /// let decomposer =
    ///     SignedDecomposer::<u32>::new(DecompositionBaseLog(4), DecompositionLevelCount(3));
    /// let output = decomposer.decompose(2u32.pow(19)).next().unwrap();
    ...
    T: UnsignedInteger,
{
    ...
    ///
    /// ```rust
    /// use rfhe::core_crypto::commons::math::decomposition::SignedDecomposerNonNative;
    /// use rfhe::core_crypto::commons::parameters::{
    ...
    ///
    /// ```rust
    /// use rfhe::core_crypto::commons::math::decomposition::{
