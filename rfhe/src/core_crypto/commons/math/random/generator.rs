...
use rfhe_versionable::{Unversionize, Versionize, VersionizeOwned};
...
impl Unversionize for CompressionSeed {
    ...
    ) -> Result<Self, rfhe_versionable::UnversionizeError> {
        Ok(versioned.into())
    }
}
...
/// use rfhe::core_crypto::commons::math::random::RandomGenerator;
...
impl<G: ByteRandomGenerator> RandomGenerator<G> {
    ...
    /// use concrete_csprng::generators::SoftwareRandomGenerator;
    /// use concrete_csprng::seeders::Seed;
    /// use rfhe::core_crypto::commons::math::random::{Gaussian, RandomGenerator, Uniform};
    ///
    /// let mut generator = RandomGenerator::<SoftwareRandomGenerator>::new(Seed(0));
    ///
    ...
    /// use concrete_csprng::generators::SoftwareRandomGenerator;
    /// use concrete_csprng::seeders::Seed;
    /// use rfhe::core_crypto::commons::ciphertext_modulus::CiphertextModulus;
    /// use rfhe::core_crypto::commons::math::random::{Gaussian, RandomGenerator, Uniform};
    ///
    /// let mut generator = RandomGenerator::<SoftwareRandomGenerator>::new(Seed(0));
    ///
    ...
    /// use concrete_csprng::seeders::Seed;
    /// use rfhe::core_crypto::commons::math::random::RandomGenerator;
    /// use rfhe::core_crypto::commons::parameters::CiphertextModulus;
    /// let mut generator = RandomGenerator::<SoftwareRandomGenerator>::new(Seed(0));
    /// let mut vec = vec![0u32; 1000];
