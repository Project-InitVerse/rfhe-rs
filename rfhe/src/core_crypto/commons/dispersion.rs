...
///
/// ```rust
/// use rfhe::core_crypto::commons::dispersion::{DispersionParameter, LogStandardDev};
...
///
/// ```rust
/// use rfhe::core_crypto::commons::dispersion::{DispersionParameter, StandardDev};
...
///
/// ```rust
/// use rfhe::core_crypto::commons::dispersion::{DispersionParameter, Variance};
