...
///
/// ```rust
/// use rfhe::core_crypto::fft_impl::common::modulus_switch;
/// use rfhe::core_crypto::prelude::compressed_modulus_switched_glwe_ciphertext::CompressedModulusSwitchedGlweCiphertext;
