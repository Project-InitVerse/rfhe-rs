    ...
    Id: FheIntId,
{
    ...
    /// ```rust
    /// use rfhe::prelude::*;
    /// use rfhe::{generate_keys, set_server_key, ConfigBuilder, FheInt16};
    ///
    ...
    /// ```rust
    /// use rfhe::prelude::*;
    /// use rfhe::{generate_keys, set_server_key, ConfigBuilder, FheBool, FheInt16};
    ///
    /// let (client_key, server_key) = generate_keys(ConfigBuilder::default());
    /// set_server_key(server_key);
    ///
    ...
    /// ```rust
    /// use rfhe::prelude::*;
    /// use rfhe::{generate_keys, set_server_key, ConfigBuilder, FheInt8};
    ///
    /// let (client_key, server_key) = generate_keys(ConfigBuilder::default());
    /// set_server_key(server_key);
    ///
    ...
    IntoId: FheIntId,
{
    ...
    /// ```rust
    /// use rfhe::prelude::*;
    /// use rfhe::{generate_keys, set_server_key, ConfigBuilder, FheInt16, FheInt32};
    ///
    /// let (client_key, server_key) = generate_keys(ConfigBuilder::default());
    /// set_server_key(server_key);
    ///
    ...
    IntoId: FheIntId,
{
    ...
    /// ```rust
    /// use rfhe::prelude::*;
    /// use rfhe::{generate_keys, set_server_key, ConfigBuilder, FheInt16, FheUint32};
    ///
    /// let (client_key, server_key) = generate_keys(ConfigBuilder::default());
    /// set_server_key(server_key);
    ///
