    ...
    Id: FheUintId,
{
    ...
    /// ```rust
    /// use rfhe::prelude::*;
    /// use rfhe::{generate_keys, set_server_key, ConfigBuilder, FheUint16};
    ///
    ...
    /// ```rust
    /// use rfhe::prelude::*;
    /// use rfhe::{generate_keys, set_server_key, ConfigBuilder, FheBool, FheUint16};
    ///
    /// let (client_key, server_key) = generate_keys(ConfigBuilder::default());
    /// set_server_key(server_key);
    ///
    ...
    /// ```rust
    /// use rfhe::prelude::*;
    /// use rfhe::{generate_keys, set_server_key, ConfigBuilder, FheUint8};
    ///
    /// let (client_key, server_key) = generate_keys(ConfigBuilder::default());
    /// set_server_key(server_key);
    ///
    ...
    IntoId: FheUintId,
{
    ...
    /// ```rust
    /// use rfhe::prelude::*;
    /// use rfhe::{generate_keys, set_server_key, ConfigBuilder, FheInt32, FheUint16};
    ///
    /// let (client_key, server_key) = generate_keys(ConfigBuilder::default());
    /// set_server_key(server_key);
    ///
    ...
    IntoId: FheUintId,
{
    ...
    /// ```rust
    /// use rfhe::prelude::*;
    /// use rfhe::{generate_keys, set_server_key, ConfigBuilder, FheUint16, FheUint32};
    ///
    /// let (client_key, server_key) = generate_keys(ConfigBuilder::default());
    /// set_server_key(server_key);
    ///
