...
use rfhe_versionable::{Upgrade, Version, Versionize, VersionsDispatch};
...
use crate::integer::backward_compatibility::ciphertext::{
    CompressedModulusSwitchedRadixCiphertextRFHE06,
    CompressedModulusSwitchedSignedRadixCiphertextRFHE06,
};
...
#[cfg_attr(rfhe_lints, allow(rfhe_lints::serialize_without_versionize))]
...
// This method was used to decompress a ciphertext in rfhe-rs < 0.7
...
pub enum CompressedSignedRadixCiphertextV0 {
    ...
    ModulusSwitched(CompressedModulusSwitchedSignedRadixCiphertextRFHE06),
}
...
pub enum CompressedRadixCiphertextV0 {
    ...
    ModulusSwitched(CompressedModulusSwitchedRadixCiphertextRFHE06),
}
