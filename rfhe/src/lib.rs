//! Welcome to the RFHE-rs API documentation!
//!
//! RFHE-rs is a fully homomorphic encryption (FHE) library that implements Initverse's variant of RFHE.
...
#[cfg(feature = "boolean")]
/// Welcome to the RFHE-rs [`boolean`](`crate::boolean`) module documentation!
///
/// # Special module attributes
/// cbindgen:ignore
pub mod boolean;

/// Welcome to the RFHE-rs [`core_crypto`](`crate::core_crypto`) module documentation!
///
/// # Special module attributes
/// cbindgen:ignore
pub mod core_crypto;
...
#[cfg(feature = "integer")]
/// Welcome to the RFHE-rs [`integer`](`crate::integer`) module documentation!
///
/// # Special module attributes
/// cbindgen:ignore
pub mod integer;
...
/// Welcome to the RFHE-rs [`shortint`](`crate::shortint`) module documentation!
///
/// # Special module attributes
/// cbindgen:ignore
pub mod shortint;
...
pub use rfhe_versionable::{Unversionize, Versionize};
