...
impl CudaServerKey {
    ...
    /// use rfhe::integer::gpu::gen_keys_radix_gpu;
    /// use rfhe::integer::{gen_keys_radix, RadixCiphertext};
    ...
    ///```rust
    /// use rfhe::core_crypto::gpu::CudaStreams;
    /// use rfhe::integer::gpu::ciphertext::{CudaRadixCiphertext, CudaUnsignedRadixCiphertext};
    /// use rfhe::integer::gpu::gen_keys_radix_gpu;
    /// use rfhe::integer::IntegerCiphertext;
    /// use rfhe::shortint::parameters::PARAM_MESSAGE_2_CARRY_2_KS_PBS;
    ///
    /// let num_blocks = 4;
    ///
    ...
    ///```rust
    /// use rfhe::core_crypto::gpu::CudaStreams;
    /// use rfhe::integer::gpu::ciphertext::CudaSignedRadixCiphertext;
    /// use rfhe::integer::gpu::gen_keys_radix_gpu;
    /// use rfhe::integer::IntegerCiphertext;
    /// use rfhe::shortint::parameters::PARAM_MESSAGE_2_CARRY_2_KS_PBS;
    ///
    ...
    /// use rfhe::integer::gpu::ciphertext::CudaUnsignedRadixCiphertext;
    /// use rfhe::integer::gpu::gen_keys_radix_gpu;
    /// use rfhe::integer::{gen_keys_radix, IntegerCiphertext};
    /// use rfhe::shortint::parameters::PARAM_MESSAGE_2_CARRY_2_KS_PBS;
    ///
    /// let num_blocks = 8;
    /// let gpu_index = 0;
