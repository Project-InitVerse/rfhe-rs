...
use rfhe_versionable::Versionize;
...
/// ```rust
/// use rfhe::integer::wopbs::{decode_radix, encode_radix};
///
/// let val = 11;
/// let basis = 2;
/// let nb_block = 5;
...
/// ```rust
/// use rfhe::integer::wopbs::split_value_according_to_bit_basis;
...
impl WopbsKey {
    ...
    /// # Example
    /// ```rust
    /// use rfhe::integer::gen_keys_radix;
    /// use rfhe::integer::wopbs::*;
    /// use rfhe::shortint::parameters::parameters_wopbs_message_carry::WOPBS_PARAM_MESSAGE_1_CARRY_1_KS_PBS;
    /// use rfhe::shortint::parameters::PARAM_MESSAGE_1_CARRY_1_KS_PBS;
    ///
    /// // Generate the client key and the server key:
    ...
    /// use rfhe::integer::gen_keys_radix;
    /// use rfhe::integer::wopbs::*;
    /// use rfhe::shortint::parameters::parameters_wopbs_message_carry::WOPBS_PARAM_MESSAGE_2_CARRY_2_KS_PBS;
    /// use rfhe::shortint::parameters::PARAM_MESSAGE_2_CARRY_2_KS_PBS;
    ///
    /// let nb_block = 3;
    /// //Generate the client key and the server key:
    ...
    /// ```rust
    /// use rfhe::integer::gen_keys_radix;
    /// use rfhe::integer::wopbs::WopbsKey;
    /// use rfhe::shortint::parameters::parameters_wopbs_only::WOPBS_ONLY_4_BLOCKS_PARAM_MESSAGE_2_CARRY_2_KS_PBS;
    ///
    /// let nb_block = 3;
    /// //Generate the client key and the server key:
    ...
    /// # Example
    /// ```rust
    /// use rfhe::integer::gen_keys_crt;
    /// use rfhe::integer::wopbs::WopbsKey;
    /// use rfhe::shortint::parameters::parameters_wopbs_message_carry::WOPBS_PARAM_MESSAGE_4_CARRY_4_KS_PBS;
    ///
    ...
    /// use rfhe::integer::gen_keys_crt;
    /// use rfhe::integer::wopbs::*;
    /// use rfhe::shortint::parameters::parameters_wopbs_message_carry::WOPBS_PARAM_MESSAGE_3_CARRY_3_KS_PBS;
    /// use rfhe::shortint::parameters::PARAM_MESSAGE_3_CARRY_3_KS_PBS;
    ///
