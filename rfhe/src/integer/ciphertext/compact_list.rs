...
impl CompactCiphertextList {
    ...
    /// };
    /// use rfhe::integer::{ClientKey, CompactPublicKey, ServerKey};
    /// use rfhe::shortint::parameters::classic::compact_pk::PARAM_MESSAGE_2_CARRY_2_COMPACT_PK_KS_PBS;
    ///
