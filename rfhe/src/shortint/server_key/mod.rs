...
pub mod compressed;
use ::rfhe_versionable::{Unversionize, UnversionizeError, Versionize, VersionizeOwned};
...
impl ServerKey {
    ...
    /// use rfhe::shortint::{gen_keys, ServerKey};
    ///
    ...
    /// ```rust
    /// use rfhe::shortint::parameters::PARAM_MESSAGE_2_CARRY_2_KS_PBS;
    /// use rfhe::shortint::{gen_keys, Ciphertext};
    ///
    /// // Generate the client key and the server key:
    /// let (cks, sks) = gen_keys(PARAM_MESSAGE_2_CARRY_2_KS_PBS);
    ///
