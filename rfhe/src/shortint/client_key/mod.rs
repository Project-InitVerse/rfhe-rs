...
impl ClientKey {
    ...
    ///
    /// ```rust
    /// use rfhe::shortint::client_key::ClientKey;
    ...
    ///
    /// ```rust
    /// use rfhe::shortint::parameters::{MessageModulus, PARAM_MESSAGE_2_CARRY_2_KS_PBS};
    /// use rfhe::shortint::ClientKey;
    ///
    /// // Generate the client key
    /// let cks = ClientKey::new(PARAM_MESSAGE_2_CARRY_2_KS_PBS);
    ...
    ///
    /// ```rust
    /// use rfhe::shortint::parameters::{MessageModulus, PARAM_MESSAGE_2_CARRY_2};
    /// use rfhe::shortint::{CarryModulus, ClientKey};
    ///
    /// // Generate the client key
