...
use crate::c_api::high_level_api::integers::{
    ...
    FheUint160, FheUint2, FheUint2048, FheUint256, FheUint32, FheUint4, FheUint6, FheUint64,
    FheUint8,
};
...
define_compact_ciphertext_list_builder_push_method!(
    unsigned: 2: u8, 4: u8, 6: u8, 8: u8, 10: u16, 12: u16, 14: u16, 16: u16, 32: u32, 64: u64, 128: U128, 160: U256, 256: U256, 2048: U2048
);
define_compact_ciphertext_list_builder_push_method!(
...
define_compact_ciphertext_list_expander_get!(unsigned: 2, 4, 6, 8, 10, 12, 14, 16, 32, 64, 128, 160, 256, 2048);
