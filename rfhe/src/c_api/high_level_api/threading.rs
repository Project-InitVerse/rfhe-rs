...
pub struct RfheThreadingContext {
    pool: ThreadPool,
}
...
#[no_mangle]
pub unsafe extern "C" fn rfhe_threading_context_create(
    num_threads: usize,
    context: *mut *mut RfheThreadingContext,
) -> c_int {
    catch_panic(|| {
        *context = std::ptr::null_mut();
        ...
        let ctx = RfheThreadingContext { pool };
...
/// `context` may be NULL
#[no_mangle]
pub unsafe extern "C" fn rfhe_threading_context_destroy(context: *mut RfheThreadingContext) {
    let _ = catch_panic(|| {
        if context.is_null() {
            return;
        }
...
#[no_mangle]
pub unsafe extern "C" fn rfhe_threading_context_set_server_key(
    context: *mut RfheThreadingContext,
...
#[no_mangle]
pub unsafe extern "C" fn rfhe_threading_context_run(
    context: *mut RfheThreadingContext,
