...
use rfhe_zk_pok::{CanonicalDeserialize, CanonicalSerialize, Compress, Validate};
...
impl CompactPkeCrs {
    ...
    #[wasm_bindgen]
    pub fn from_config(config: &RfheConfig, max_num_bits: usize) -> Result<CompactPkeCrs, JsError> {
        catch_panic_result(|| {
