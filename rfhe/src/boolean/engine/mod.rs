...
impl BooleanEngine {
    ...
    ///
    /// ```rust
    /// use rfhe::boolean::engine::BooleanEngine;
    /// use rfhe::core_crypto::commons::generators::DeterministicSeeder;
    /// use rfhe::core_crypto::commons::math::random::Seed;
    /// use rfhe::core_crypto::prelude::ActivatedRandomGenerator;
    ///
    ...
    /// let (cks, sks) = rfhe::boolean::gen_keys();
    /// ```
