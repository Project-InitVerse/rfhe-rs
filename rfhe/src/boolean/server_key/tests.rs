...
#[cfg(not(tarpaulin))]
mod rfhe_lib_parameters_tests {
    use super::*;
    use crate::boolean::parameters::RFHE_LIB_PARAMETERS;

    #[test]
    fn test_encrypt_decrypt_lwe_secret_key_rfhe_lib_parameters() {
        test_encrypt_decrypt_lwe_secret_key(RFHE_LIB_PARAMETERS);
    }
    #[test]
    fn test_and_gate_rfhe_lib_parameters() {
        test_and_gate(RFHE_LIB_PARAMETERS);
    }
    #[test]
    fn test_nand_gate_rfhe_lib_parameters() {
        test_nand_gate(RFHE_LIB_PARAMETERS);
    }
    #[test]
    fn test_or_gate_rfhe_lib_parameters() {
        test_or_gate(RFHE_LIB_PARAMETERS);
    }
    #[test]
    fn test_nor_gate_rfhe_lib_parameters() {
        test_nor_gate(RFHE_LIB_PARAMETERS);
    }
    #[test]
    fn test_xor_gate_rfhe_lib_parameters() {
        test_xor_gate(RFHE_LIB_PARAMETERS);
    }
    #[test]
    fn test_xnor_gate_rfhe_lib_parameters() {
        test_xnor_gate(RFHE_LIB_PARAMETERS);
    }
    #[test]
    fn test_not_gate_rfhe_lib_parameters() {
        test_not_gate(RFHE_LIB_PARAMETERS);
    }
    #[test]
    fn test_mux_gate_rfhe_lib_parameters() {
        test_mux_gate(RFHE_LIB_PARAMETERS);
    }
    #[test]
    fn test_deep_circuit_rfhe_lib_parameters() {
        test_deep_circuit(RFHE_LIB_PARAMETERS);
    }
}
