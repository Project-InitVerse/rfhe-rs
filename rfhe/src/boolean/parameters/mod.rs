...
//!  * `rfhe::boolean::parameters::DEFAULT_PARAMETERS`
//!  * `rfhe::boolean::parameters::RFHE_LIB_PARAMETERS`
//!
...
//! with an higher probability error in comparison with the `RFHE_LIB_PARAMETERS`.
...
impl BooleanParameters {
    ...
    /// [`RFHE_LIB_PARAMETERS`], which both offer correct results with 128 bits of security.
...
/// This parameter set allows to evaluate faster Boolean circuits than the `RFHE_LIB_PARAMETERS`
/// one.
...
/// Parameter sets given in RFHE-lib:
/// <https://github.com/rfhe/rfhe/blob/bc71bfae7ad9d5f8ce5f29bdfd691189bfe207f3/src/librfhe/rfhe_gate_bootstrapping.cpp#L51>
/// Original security in 2020 was 129-bits, while it is currently around 120 bits.
pub const RFHE_LIB_PARAMETERS: BooleanParameters = BooleanParameters {
