...
use std::fmt::Debug;
use rfhe_zk_pok::proofs::pke::crs_gen;

pub use rfhe_zk_pok::proofs::ComputeLoad as ZkComputeLoad;
pub use rfhe_zk_pok::{CanonicalDeserialize, CanonicalSerialize, Compress, Validate};
type Curve = rfhe_zk_pok::curve_api::Bls12_446;
pub type CompactPkeProof = rfhe_zk_pok::proofs::pke::Proof<Curve>;
pub type CompactPkePublicParams = rfhe_zk_pok::proofs::pke::PublicParams<Curve>;
...
impl CompactPkeCrs {
    ...
    ///
    /// The output of this function can be used in [rfhe_zk_pok::proofs::pke::compute_crs_params].
