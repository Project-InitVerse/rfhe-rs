...
pub mod boolean_utils {
    use super::*;
    use rfhe::boolean::parameters::BooleanParameters;
...
pub mod shortint_utils {
    ...
    use rfhe::shortint::parameters::compact_public_key_only::CompactPublicKeyEncryptionParameters;
    use rfhe::shortint::parameters::list_compression::CompressionParameters;
    #[cfg(feature = "gpu")]
    use rfhe::shortint::parameters::PARAM_GPU_MULTI_BIT_MESSAGE_2_CARRY_2_GROUP_3_KS_PBS;
    #[cfg(not(feature = "gpu"))]
    use rfhe::shortint::parameters::PARAM_MULTI_BIT_MESSAGE_2_CARRY_2_GROUP_2_KS_PBS;
    use rfhe::shortint::parameters::{
        ShortintKeySwitchingParameters, PARAM_MESSAGE_2_CARRY_2_KS_PBS,
    };
    use rfhe::shortint::PBSParameters;
    ...
    pub struct ParamsAndNumBlocksIter {
        params_and_bit_sizes:
            itertools::Product<IntoIter<rfhe::shortint::PBSParameters>, IntoIter<usize>>,
    }
    ...
    impl Iterator for ParamsAndNumBlocksIter {
        type Item = (rfhe::shortint::PBSParameters, usize, usize);
...
impl EnvConfig {
    #[allow(dead_code)]
    pub fn new() -> Self {
        let is_multi_bit = match env::var("__RFHE_RS_BENCH_TYPE") {
            Ok(val) => val.to_lowercase() == "multi_bit",
            Err(_) => false,
        };

        let is_fast_bench = match env::var("__RFHE_RS_FAST_BENCH") {
