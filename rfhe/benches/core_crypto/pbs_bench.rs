...
use rayon::prelude::*;
use serde::Serialize;
use rfhe::boolean::parameters::{
    BooleanParameters, DEFAULT_PARAMETERS, PARAMETERS_ERROR_PROB_2_POW_MINUS_165,
};
use rfhe::core_crypto::commons::math::ntt::ntt64::Ntt64;
...
fn mem_optimized_pbs_ntt(c: &mut Criterion) {
    ...
    let custom_ciphertext_modulus =
        rfhe::core_crypto::prelude::CiphertextModulus::new((1 << 64) - (1 << 32) + 1);
...
mod cuda {
    ...
    use serde::Serialize;
    use rfhe::core_crypto::gpu::glwe_ciphertext_list::CudaGlweCiphertextList;
    use rfhe::core_crypto::gpu::lwe_bootstrap_key::CudaLweBootstrapKey;
    use rfhe::core_crypto::gpu::lwe_ciphertext_list::CudaLweCiphertextList;
    use rfhe::core_crypto::gpu::lwe_multi_bit_bootstrap_key::CudaLweMultiBitBootstrapKey;
    use rfhe::core_crypto::gpu::vec::CudaVec;
    use rfhe::core_crypto::gpu::{
    ...
    use rfhe::shortint::{ClassicPBSParameters, PBSParameters};
