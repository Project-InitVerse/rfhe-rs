...
use rfhe::boolean::client_key::ClientKey;
...
use rfhe::boolean::prelude::BinaryBooleanGates;
use rfhe::boolean::server_key::ServerKey;
...
fn bench_rfhe_lib_parameters(c: &mut Criterion) {
    benches(c, RFHE_LIB_PARAMETERS, " RFHE_LIB_PARAMETERS");
}
