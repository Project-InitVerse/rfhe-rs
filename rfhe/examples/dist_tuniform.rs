use rfhe::prelude::*;
use rfhe::shortint::parameters::DynamicDistribution;
use rfhe::{generate_keys, set_server_key, ConfigBuilder, FheUint32};

fn main() -> Result<(), Box<dyn std::error::Error>> {
    let mut my_params = rfhe::shortint::parameters::PARAM_MESSAGE_2_CARRY_2_KS_PBS;
