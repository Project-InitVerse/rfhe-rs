...
use std::io::Write;
use std::path::Path;
use rfhe::boolean::parameters::{DEFAULT_PARAMETERS, PARAMETERS_ERROR_PROB_2_POW_MINUS_165};
use rfhe::boolean::{client_key, server_key};
...
fn client_server_key_sizes(results_file: &Path) {
    let boolean_params_vec = [
        ...
        (PARAMETERS_ERROR_PROB_2_POW_MINUS_165, "RFHE_LIB_PARAMETERS"),
    ];
