...
use rfhe::integer::bigint::static_unsigned::StaticUnsignedBigInt;
use rfhe::integer::prelude::*;
use rfhe::integer::{BooleanBlock, RadixCiphertext, ServerKey as FheServerKey};
...
impl ServerKey {
    ...
    fn left_shift_chars(&self, str: &FheString, shift: &RadixCiphertext) -> FheString {
        ...
        // `shift_bits` needs to have the same block len as `uint` for the rfhe-rs shift to work
        ...
        // range (instead of wrapping, which is the behavior of Rust and rfhe-rs)
