...
use crate::N;
use rfhe::integer::{IntegerCiphertext, IntegerRadixCiphertext, RadixCiphertext};
...
impl FheString {
    ...
    // We can then use a single large uint, that represents a string, in rfhe-rs operations.
