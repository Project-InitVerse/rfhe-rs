...
mod check_rfhe_docs_are_tested;
...
const CHECK_RFHE_DOCS_ARE_TESTED: &str = "check_rfhe_docs_are_tested";
...
fn main() -> Result<(), std::io::Error> {
    ...
    let matches = Command::new("tasks")
        ...
        .subcommand(
            Command::new(CHECK_RFHE_DOCS_ARE_TESTED)
    ...
    if matches.subcommand_matches(FORMAT_LATEX_DOC).is_some() {
        ...
        .subcommand_matches(CHECK_RFHE_DOCS_ARE_TESTED)
        .is_some()
    {
        check_rfhe_docs_are_tested::check_rfhe_docs_are_tested()?;
    }
