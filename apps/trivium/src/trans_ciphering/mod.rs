...
use rayon::prelude::*;
use rfhe::prelude::*;
use rfhe::shortint::Ciphertext;
use rfhe::{set_server_key, unset_server_key, FheUint64, FheUint8, ServerKey};
...
fn transcipher_from_1_1_stream(
    ...
    internal_server_key: &rfhe::shortint::ServerKey,
    casting_key: &rfhe::shortint::KeySwitchingKey,
) -> FheUint64 {
