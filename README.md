...
<p align="center">
  ...
  <a href="https://github.com/Project-InitVerse/bounty-program"><img src="https://img.shields.io/badge/Contribute-Initverse%20Bounty%20Program-%23ffd208?style=flat-square"></a>
</p>
...
- **Low-level cryptographic library** that implements Initverse’s variant of RFHE, including programmable bootstrapping
- **Implementation of the original RFHE boolean API** that can be used as a drop-in replacement for other RFHE libraries
...
```text
@Misc{RFHE-rs,
  title={{RFHE-rs: A Pure Rust Implementation of the RFHE Scheme for Boolean and Integer Arithmetics Over Encrypted Data}},
  author={Initverse},
  year={2022},
  note={\url{https://github.com/Project-InitVerse/rfhe-rs}},
}
```
